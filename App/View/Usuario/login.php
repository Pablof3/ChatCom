      ...
      <div class="media align-items-stretch justify-content-center ht-100p pos-relative">
        ...
        <div class="sign-wrapper mg-lg-l-50 mg-xl-l-60">
          <div class="wd-100p">
            ...
            <p class="tx-color-03 tx-16 mg-b-40">Bienvenido! Ingrese sus datos para continuar.</p>
            ...
            <button onclick="window.location.href='<?=RUTA_URL?>Usuario/Perfil'" class="btn btn-brand-02 btn-block">Ingresar</button>
          </div>
        </div><!-- sign-wrapper -->
      </div><!-- media -->
    </div><!-- container -->
